...
function () {
  ...
  Object.defineProperty(Model.prototype, "on", {
    //methods dont need coordination
    get: function get() {
...
function () {
  function Attributes(data) {
    ...
    this.data = data; //we can use generics on metods Definition as well
...
function () {
  ...
  ApiSync.prototype.fetch = function (id) {
    //creating a get req by id and return a promise
...
function () {
  function Eventing() {
    ...
    this.events = {}; //on convert to arrow function becouse now this keyword will reference to user insted of undefined

    this.on = function (eventName, callback) {
      var handlers = _this.events[eventName] || []; //when we first create a user events are undefined
...
function () {
  function Collection(rootUrl, deserialize) {
    this.rootUrl = rootUrl;
    this.deserialize = deserialize; //K represents json data
...
function (_super) {
  ...
  } //static will give us preconfiguret instance of user
...
},{"./views/UserForm":"src/views/UserForm.ts","./models/User":"src/models/User.ts"}],"../../../n/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
